      ...
      <div className="grid grid-cols-[70%30%] gap-x-5 container mt-10">
        <div>
          ...
          <ul className="ml-5 list-disc">
            ...
            <li>10 функционалности</li>
            <li>Корекции по функционалността на сайт</li>
            <li>Обновяване на остарели и уязвими модули</li>
          </ul>
          <div className="max-w-2xl mt-4 text-sm"><span class="text-red-500">*</span> Всяка една услуга която включва бройки, всеки месец се добяват, а не започват наново
          <br/>
            
            <span class="text-red-500">*</span> Примерно: Първият месец в абонамента сте имали &quot;Създаване на два продукта&quot;, обаче не е създанен нито един. Вторият месец ще имате четири продукта продукта
            , демек се надчисляват, над тези които имате. 
            <br/>
            <span class="text-red-500">*</span> Същото се отнася и за функционалностите
          </div>
